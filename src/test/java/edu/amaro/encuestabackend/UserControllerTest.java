...
public class UserControllerTest {
    ...
    @Test
    public void createUser_sinNingunDato_retornaMensajeDeErrorDeValidacionParaElNombre(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
        user.setName(null);
    ...
    @Test
    public void createUser_sinNingunDato_retornaMensajeDeErrorDeValidacionParaElEmail(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
        user.setEmail(null);
    ...
    @Test
    public void createUser_sinNingunDato_retornaMensajeDeErrorDeValidacionParaElPassword(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
        user.setPassword(null);
    ...
    @Test
    public void createUser_conUsuaruiValido_retornaOK(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
    ...
    @Test
    public void createUser_conUsuaruiValido_retornaUserRest(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
        ResponseEntity<UserRest> response = register(user, UserRest.class);
    ...
    @Test
    public void createUser_conUsuaruiValido_guardaElUsuarioEnLaBaseDeDatos(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
        ResponseEntity<UserRest> response = register(user, UserRest.class);
    ...
    @Test
    public void createUser_conUsuaruiValido_guardaElPasswordConHashEnLaBaseDeDatos(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
        ResponseEntity<UserRest> response = register(user, UserRest.class);
        UserEntity userDb = userRepository.findById(response.getBody().getId());
    ...
    @Test
    public void createUser_conUsuaruiValido_conCorreoExistente_retornaBadRequest(){
        UserRegisterRequestModel user = TestUtil.createValidUser();
    ...
    // @Test
    // public void getUser_connTokenDeAutenticacion_retornaUserRest(){
    //     UserRegisterRequestModel user = TestUtil.createValidUser();
    ...
    //     String token = body.get("token").replace("Baerer ", "");
    ...
    public <T> ResponseEntity<T> getUser(String token, ParameterizedTypeReference<T> responseType){
        ...
        String token2 = token.replace("Baerer ", "");
        headers.setBearerAuth(token2);
        HttpEntity<Object> entity = new HttpEntity<Object>(token, headers);
